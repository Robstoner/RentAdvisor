...
namespace RentAdvisor.Server.Migrations
{
    ...
    [Migration("20250203152057_Add default title to user")]
    partial class Adddefaulttitletouser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentAdvisor.Server.Models.Entities.Badge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RentAdvisor.Server.Models.Entities.Title", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BadgeUser", b =>
                {
                    b.HasOne("RentAdvisor.Server.Models.Entities.Badge", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RentAdvisor.Server.Models.Entities.User", b =>
                {
                    b.HasOne("RentAdvisor.Server.Models.Entities.Title", "Title")
                        .WithMany("Users")
